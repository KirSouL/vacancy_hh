...
# #
# one = WorkVacancy("Python", "https/fsfs", "Russia",
#                    102000, 150000,  "USD",
#                    "Minimum 1 year of experience with ReactJS")
# two = WorkVacancy("Python", "https/fsfs", "Russia",
#                    None, 150000,  "USD",
#                    "Minimum 1 year of experience with ReactJS")
# three = WorkVacancy("Python", "https/fsfs", "Russia",
#                    None, None,  "USD",
#                    "Minimum 1 year of experience with ReactJS")
# print(two)
# print(three)
# print(one.__repr__())
#
# two = WorkVacancy("JAVA", "https/fsfs", "Russia",
#                   101000,  152000,"USD",
#                   "Minimum 1 year of experience with ReactJS")
#
# print(one.__le__(two))